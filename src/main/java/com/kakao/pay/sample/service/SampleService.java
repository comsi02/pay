...
public class SampleService {
    ...
    public ReadyResponse ready(String agent, String openType) {
        ...
        paramMap.add("partner_order_id", "test12345");                  // 주문번호 : test12345  를 사용
        ...
        /*
        paramMap.add("approval_url", "http://developers.kakao.com/approve/" + agent + "/" + openType);  // 결제성공 redirect url
        paramMap.add("cancel_url", "http://developers.kakao.com/cancel/" + agent + "/" + openType);     // 결제취소 redirect url
        paramMap.add("fail_url", "http://developers.kakao.com/fail/" + agent + "/" + openType);         // 결제실패 redirect url
        */
